...
console.log('dot-notation = ', person.myAge);

console.log('bracket-notation =', person["firstName"]);
console.log('bracket-notation =', person["myAge"]);

console.log('dot-notation =', person.evaluations);
console.log('brack-notation =', person["evaluations"]);
